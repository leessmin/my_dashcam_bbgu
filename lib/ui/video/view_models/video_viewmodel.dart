...
class VideoViewModel extends ChangeNotifier {
  VideoViewModel({
    ...
    required VideoExportRepository videoExportRepository,
    required this.dirName,
  }) : _videoDirectoryRepository = videoDirectoryRepository,
       _videoExportRepository = videoExportRepository {
    loadVideos();
  }

  final VideoDirectoryRepository _videoDirectoryRepository;
  final VideoExportRepository _videoExportRepository;
  ...
  Future<void> loadVideos() async {
    _videos = await _videoDirectoryRepository.getVideos(dirName);
  ...
  ValueNotifier<String> get exportProgress =>
      _videoExportRepository.exportProgress;
